...
//status update
    ...
    private void lastMessage(final String userid, final TextView last_msg){
        ...
        final FirebaseUser firebaseUser = FirebaseAuth.getInstance().getCurrentUser(); //initializing firebase user
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Chats"); //initializing firebase reference
